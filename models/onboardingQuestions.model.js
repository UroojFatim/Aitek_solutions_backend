...
import { FIELD_TYPE_VALUES, DEFAULT_FIELD_TYPE } from "../enums/index.js";

const OnboardingQuestions = sequelize.define(
  "OnboardingQuestions",
  {
    id: {
      type: DataTypes.UUID,
  ...
  },
  {
    ...
    indexes: [
      {
        fields: ['step_id', 'section_id', 'display_order']
      },
      {
        fields: ['section_id', 'display_order']
      },
      {
        fields: ['field_name']
      },
      {
        unique: true,
        fields: ['step_id', 'section_id', 'field_name'],
        name: 'unique_field_per_step'
      }
    ]
  }
);
